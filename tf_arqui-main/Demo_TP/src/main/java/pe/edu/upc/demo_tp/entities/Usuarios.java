...
public class Usuarios {
    ...
    public Usuarios(int idUsuario, String usuario, String contraseña, String correo, String telefono, LocalDate fechanac, String nombre, String apellido, String tipousuario) {
        this.idUsuario = idUsuario;
        this.usuario = usuario;
        this.contraseña = contraseña;
        this.correo = correo;
